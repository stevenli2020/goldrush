"""Reader and signed-change signal for approved L1-002."""
...
def read_l1_002(path: str | Path) -> list[dict[str, Any]]:
    return read_series(path, VARIABLE_ID, UNIT)


def signed_change_l1_002(records: list[dict[str, Any]], horizon: str) -> dict[str, Any]:
