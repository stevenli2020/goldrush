...
try:
    ...
    dxy_result = obb.equity.price.historical(symbol='DX-Y.NYB', start_date='2026-01-01', provider='yfinance')
...
try:
    ...
    cny_result = obb.equity.price.historical(symbol='CNY=X', start_date='2026-01-01', provider='yfinance')
