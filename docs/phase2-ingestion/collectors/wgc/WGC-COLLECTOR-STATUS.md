...
- Raw workbooks are preserved by category and identified with SHA-256 hashes.
...
All eight mapped targets returned `PASS` during the reviewed forced regression.
...
> WGC collector review is complete. The shared downloader/extractor and eight
> mappings passed regression: L0-001, L0-002, L0-003, L0-005, L0-006, L5-001,
> L5-002, and L8-001. Raw workbooks, SHA-256 manifests, logs, parser-specific
...
> Routine runs skip unchanged files; `--force` is reserved for deliberate
