...
OUTPUT_FIELDS = [
    "variable_id", "observation_date", "observation_year",
    "fiscal_balance_pct_gdp", "unit", "sign_convention", "period_definition",
    "source_name", "source_series_id", "source_release", "raw_file_path",
    "manifest_path", "raw_sha256", "retrieved_at", "validation_status",
...
def parse_observations(
    ...
    *,
    ...
    availability = operational_availability(
        max(by_year), today=current_date, stale_after_days=stale_after_days
    )
    ...
    for year in sorted(by_year):
        ...
        rows.append({
            ...
            "fiscal_balance_pct_gdp": value,
            "unit": "percent_of_gdp",
            "sign_convention": "negative=deficit; positive=surplus",
            "period_definition": "federal fiscal-year balance divided by annual calendar-year GDP, using FRED's published year label",
            "source_name": "FRED",
            ...
            "validation_status": "PASS" if -30 <= value <= 10 else "FLAG",
