...
- Regression verification: compilation passed; 13 L5-003 tests and 27 combined Batch 7 tests passed. Live parsing remained 109 schema-valid rows with unchanged latest values and output hash. Actual CLI fallback produced one schema-valid `STALE` row.
...
- Added a small official CSV collector, immutable raw snapshots, SHA-256 manifests, variable parser, schema, tests, and operational documentation.
...
- Provenance: raw 326,382-byte CSV SHA-256 `d323c570c00b6fcdc481feafb0822354b10fde3df1bd167227d9f42dfcddc626`; raw/manifest/processed hash chain verified. Actual CLI `STALE`, `BLOCKED`, recovery cleanup, and deterministic replay passed.
