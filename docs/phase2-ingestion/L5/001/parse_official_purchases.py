...
def parse_file(path: Path, publication_date: str, download_date: str) -> pd.DataFrame:
    ...
    # The workbook includes alternative series such as gross Turkey* and adjusted Turkey.
    # Use the canonical displayed country series and exclude rows explicitly marked '*'.
