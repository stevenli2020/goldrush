...
| **L2-002** | Broad Trade-Weighted Nominal US Dollar Index | Complete | Y | `fredapi`, `openbb` | Y | N | N |
...
| **L3-005** | FOMC Dot Plot Path | Complete | N | — | Y (official Fed HTML/PDF) | Y | N |
| **L3-006** | FOMC Statements / Forward-Guidance Signal | Complete | N | — | Y (official Fed HTML/PDF) | Y | N |
...
| **L4-009** | Treasury Maturity Structure | Complete | N | — | Y (Treasury Fiscal Data API) | N | N |
...
| **L5-003** | Reserve Composition Change / USD Share Change | Complete | Y | `openbb`, `imf-data` | Y | N | N |
...
| **L7-003** | Global Private Non-Financial Credit Growth | Complete | Y | OpenBB / BIS API | Y | N | N |
