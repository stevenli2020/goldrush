...
- Live run completed 2026-08-23 using shared FRED client: 6,945 raw observations, 6,675 numeric observations parsed. Latest observation: 2026-08-14 = 6.7412 CNY/USD. Raw SHA-256: `566a05fd2337a329a533918029e8e819cf5313ef094064d0bcca11f7b7ae6273`. All 6,675 rows are schema-valid; validation is 6,675 `PASS`, with 2 `AVAILABLE` and 6,673 `STALE` under the ten-day freshness rule.
