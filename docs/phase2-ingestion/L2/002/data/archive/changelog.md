...
- Live run completed 2026-08-23: 5,169 numeric observations parsed from 5,380 raw observations; all rows schema-valid and PASS. Latest observation: 2026-08-14 = 118.9028. Raw source metadata: ``.
