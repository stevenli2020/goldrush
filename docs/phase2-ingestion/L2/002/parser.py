...
OUTPUT_FIELDS = [
    "variable_id", "observation_date", "index_value", "unit", "index_definition",
    "source_name", "source_series_id", "source_release", "raw_file_path", "raw_sha256",
...
def parse_observations(
    ...
    *,
    ...
    if manifest.get("sha256") and manifest["sha256"] != raw_hash:
    ...
    for date_text in sorted(observed):
        ...
        rows.append({
            ...
            "index_value": value,
            "unit": "index",
            "index_definition": "Index Jan 2006=100, not seasonally adjusted",
            "source_name": "FRED",
            "source_series_id": SERIES_ID,
            "source_release": "H.10 Foreign Exchange Rates",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.raw:
            rows = parse_observations(args.raw, manifest_path=args.manifest,
