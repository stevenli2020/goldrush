...
class GoldETFHoldingsParser:
    ...
    def _log_error(self, row_idx, raw_data, reason, action="REJECTED"):
        ...
        # Ensure archive directory exists and write log
    ...
    def parse_workbook(self, file_path: Path, publication_date: str, download_date: str, prior_records=None):
        ...
        for row_num, row in enumerate(rows[header_idx + 1:], start=header_idx + 2):
            ...
            record = {
                ...
                "region": region,
                "holdings_tonnes": round(tonnes_val, 2),
                "aum_usd_bn": round(aum_val, 2) if aum_val is not None else None,
                "unit": "metric_tonnes",
                ...
                "revision_metadata": {
                    ...
                    "revision_reason": "Value updated from baseline" if is_revision else None,
                },
