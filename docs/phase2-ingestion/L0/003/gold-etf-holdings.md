...
3. **Large Changes:** Percentage changes greater than $5\%$ between consecutive source observations flag `WARNING_ABNORMAL_CHANGE`. This is a review warning; the source-backed numeric value remains usable unless another validation rule rejects it.
