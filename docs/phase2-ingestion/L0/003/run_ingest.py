...
def main():
    ...
    # 1. SHA-256 and Timestamps
    file_sha256 = calculate_sha256(SOURCE_FILE)
    ...
    audit_entry = {
        ...
        "rejected_rows_count": fail_count,
        "warnings": parser.validation_errors,
