...
OUTPUT_FIELDS = [
    "variable_id", "observation_date", "fed_total_assets_millions_usd", "unit",
    "observation_definition", "source_name", "source_series_id", "source_release",
    "raw_file_path", "manifest_file_path", "raw_sha256", "retrieved_at",
    ...
    *,
    ...
    for date_text in sorted(observed):
        ...
        rows.append({
            ...
            "fed_total_assets_millions_usd": value,
            "unit": "millions_usd",
            "observation_definition": "Federal Reserve total assets, Wednesday level",
            "source_name": "FRED",
            "source_series_id": SERIES_ID,
            "source_release": "H.4.1 Factors Affecting Reserve Balances",
            "raw_file_path": str(raw_path),
            "manifest_file_path": str(manifest_path),
            "raw_sha256": raw_hash,
            "retrieved_at": retrieved_at,
            "validation_status": "PASS" if 100_000 <= value <= 50_000_000 else "FLAG",
