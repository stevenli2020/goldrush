...
OUTPUT_FIELDS = [
    "variable_id", "observation_date", "high_yield_oas_pct", "unit",
    "observation_definition", "source_name", "source_series_id", "source_release",
    "source_attribution", "raw_file_path", "manifest_file_path", "raw_sha256",
...
def parse_observations(
    ...
    *,
    ...
    if manifest.get("sha256") != raw_hash:
        raise ValueError("raw file hash does not match manifest")
    ...
    for date_text in sorted(observed):
        ...
        rows.append({
            ...
            "high_yield_oas_pct": value,
            "unit": "percentage_points",
            "observation_definition": "ICE BofA US High Yield Index option-adjusted spread at daily close",
            "source_name": "FRED",
            "source_series_id": SERIES_ID,
            "source_release": "ICE BofA Indices",
            "source_attribution": "ICE Data Indices, LLC via FRED",
            "raw_file_path": str(raw_path),
            "manifest_file_path": str(manifest_path),
            "raw_sha256": raw_hash,
            "retrieved_at": retrieved_at,
            "validation_status": "PASS" if 0.5 <= value <= 30 else "FLAG",
